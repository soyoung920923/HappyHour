...
<main>
	...
	<div class="my-3 p-3 bg-white rounded shadow-sm" style="padding-top: 10px; margin-left: 50px; margin-right: 70px;">
		<form:form name="f" id="f"  modelAttribute="commentDTO" method="POST">
		<input type="hidden" id="num" value="${board.num}"/>
			<div class="row">
				<div class="col-sm-10">
					<textarea id="ccontent" class="form-control" rows="3" placeholder="댓글을 입력해 주세요"></textarea>
				</div>
				<div class="col-sm-2">
			...
			if(result.length < 1){
				htmls += '<br><div>등록된 댓글이 없습니다.</div>';
	                    ...
	                    $(result).each(function(){
	                     ...
	                     htmls += '<a href="javascript:void(0)" onclick="fn_editReply(' + this.cnum + ', \'' + this.id + '\', \'' + this.ccontent + '\' )" style="padding-right:5px">수정</a>';
